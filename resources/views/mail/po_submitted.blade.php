                            ...
                            <table class="email-body_inner" align="center" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p>A new Purchase Order (PO) has been submitted for Order
                                            #{{ str_pad($order->id, 6, '0', STR_PAD_LEFT) }}.</p>

                                        <p>Please review the uploaded PO file and proceed with order fulfillment. Below is a summary of the order details:</p>
                                        ...
                                        <table class="table-summary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">{{ $order->company->name }}</td>
                                            </tr>
                                            <tr>
                                        ...
                                        @if($order->po_attachment)
                                            <p><strong>The buyer's uploaded PO document is attached to this email.</strong></p>
                                        @endif

                                        <div class="action-box">
                                            <p style="margin-bottom: 15px; font-weight: bold;">Review and Manage Order</p>
                                        ...
                                        <p>Best regards,<br />The {{ $settings->name ?? 'Procurement' }} System</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
