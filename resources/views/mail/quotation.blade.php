                            ...
                            <table class="email-body_inner" align="center" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p>We are pleased to provide your official quotation for Order
                                            #{{ str_pad($order->id, 6, '0', STR_PAD_LEFT) }}.</p>

                                        <p>Your proposal has been finalized and is now ready for your confirmation.
                                            Below is the high-level summary:</p>
                                        ...
                                        <p><strong>A full detailed PDF breakdown is attached to this email.</strong></p>

                                        <div class="action-box">
                                            <p style="margin-bottom: 15px; font-weight: bold;">Ready to proceed?</p>
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td>
                                                        <a href="{{ url('/orders') }}" class="button"
                                                            target="_blank">View Order Online</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>

                                        <p>If you accept this pricing, you can upload your official Purchase Order
                                            directly through our portal, or respond to this email.</p>
