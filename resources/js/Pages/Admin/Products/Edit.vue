...
const updatePrimaryState = () => {
    ...
    if (primaryImg) {
        form.primary_type = primaryImg.type;
        form.primary_value = primaryImg.type === 'existing' ? primaryImg.id : (primaryImg.type === 'new' ? primaryImg.index : null);
    } else {
        form.primary_type = 'main';
        form.primary_value = null;
    }
};
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">You can select multiple images. The primary image will be the main catalog image.</p>
